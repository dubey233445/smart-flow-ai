    ...
    <section id="why" className="relative py-20 md:py-24 bg-background">
      <div className="mx-auto max-w-content px-6 md:px-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <ul className="mt-8 space-y-5">
            {points.map((p) => (
              <li key={p.title} className="flex gap-4 group">
                <span className="mt-1 h-7 w-7 grid place-items-center rounded-md bg-gradient-primary shadow-glow-primary shrink-0 group-hover:scale-110 transition-transform">
        ...
        <div className="relative">
          ...
          <div className="relative rounded-2xl bg-gradient-to-br from-muted to-white border border-border p-6 shadow-card animate-float-slow">
