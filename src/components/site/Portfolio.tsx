...
const demos = [
  {
    ...
    idealFor: "Schools & Colleges, Educational Institutes, Teachers & Examiners, Online Learning Platforms, Coaching Centers, EdTech Startups",
  ...
  },
  {
    ...
    tag: "Hashtag AI",
    title: "HashBoost AI",
    shortDesc: "AI-powered hashtag generator for all platforms",
    ...
    idealFor: "Influencers, Content Creators, Digital Marketers, Agencies",
    ...
    <section id="portfolio" className="relative py-20 md:py-24 bg-muted">
      <div className="mx-auto max-w-content px-6 md:px-10">
        <Reveal as="div" className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
<<<<<<< HEAD
            <p className="text-sm font-medium text-primary mb-3">Our work</p>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground">
              Featured <span className="text-gradient">Projects</span>
            </h2>
          </div>
          <p className="text-muted-foreground max-w-md leading-relaxed">
            Innovative AI-powered solutions we've built to help creators, educators, and businesses succeed.
=======
...
<<<<<<< HEAD
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="font-display font-semibold text-lg text-foreground mb-1">{d.title}</h3>
                  <p className="text-sm text-primary font-medium mb-3">{d.shortDesc}</p>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-muted-foreground">{d.idealFor}</p>
                  </div>
                  
                  <Button variant="glass" size="sm" className="btn-press group/btn mt-auto w-full" asChild>
